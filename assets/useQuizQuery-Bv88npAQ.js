import{n as e}from"./react-core-DJTOdx8O.js";import{t}from"./lib-BINeO7UO.js";import{n}from"./react-query-DU5vuMLf.js";import{t as r}from"./config-CiZspjMR.js";var i=e(),a=async e=>{let t=await r.get(`/quizzes/${e}/basic`);return{quiz:{id:t.id,title:t.title,questions:t.questions||[]}}},o={all:[`quizzes`],lists:()=>[...o.all,`list`],list:e=>[...o.lists(),{filters:e}],details:()=>[...o.all,`detail`],detail:e=>[...o.details(),e],stats:e=>[...o.details(),e,`stats`],attempts:e=>[...o.details(),e,`attempts`]},s=async e=>r.post(`/quizzes/${e.quizId}/submit`,e),c=t`
